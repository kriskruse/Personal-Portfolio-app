...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <a
      ...
      className="group block p-5 bg-white/60 dark:bg-zinc-800/60 rounded-xl shadow-md backdrop-blur-sm hover:shadow-lg hover:bg-white/80 dark:hover:bg-zinc-700/60 transition-all duration-200"
    >
      {/* Icon + Title row */}
      ...
      {/* Link hint */}
      <span className="inline-flex items-center gap-1 text-xs font-medium text-purple-600 dark:text-purple-400 opacity-0 group-hover:opacity-100 transition-opacity">
        View project
        <svg
