...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <a
      ...
      className="group block p-5 bg-zinc-800/60 rounded-xl shadow-md backdrop-blur-sm hover:shadow-lg hover:bg-zinc-700/60 transition-all duration-200 hover:scale-[1.02]"
    >
      {/* Icon + Title row */}
